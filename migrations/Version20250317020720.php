 ...
 */
final class Version20250317020720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture CHANGE reference reference VARCHAR(255) DEFAULT NULL, CHANGE montant montant VARCHAR(255) DEFAULT NULL, CHANGE moyenpaiemant moyenpaiemant VARCHAR(255) DEFAULT NULL, CHANGE datefacture datefacture DATE DEFAULT NULL, CHANGE tva tva DOUBLE PRECISION DEFAULT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL, CHANGE resteapayer resteapayer VARCHAR(255) DEFAULT NULL');
